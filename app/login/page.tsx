  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/2 -translate-x-1/2 w-[400px] h-[300px] bg-fuchsia-600/8 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center gap-3 mb-2">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-white/40 mt-1">Instagram DM Automation Platform</p>
          </div>
        </div>

        {/* Clerk SignIn — Google enabled in Clerk dashboard */}
        <SignIn
          appearance={{
            elements: {
              rootBox: 'w-full',
