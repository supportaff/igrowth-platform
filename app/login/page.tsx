...
// Dummy credentials — replace with real auth (Clerk / Supabase) later
const DUMMY_EMAIL = 'demo@igrowth.app'
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (email === DUMMY_EMAIL && password === DUMMY_PASSWORD) {
      ...
      setLoading(false)
      setError('Invalid email or password. Try demo@igrowth.app / demo1234')
    }
  }
    ...
    <div className="min-h-screen bg-[#0f0f1a] text-white flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16 relative">
        <div className="w-full max-w-md">
          ...
          {/* Demo hint */}
          <div className="mb-5 p-3 bg-brand-500/10 border border-brand-500/25 rounded-xl text-xs text-brand-300 text-center">
            <span className="font-semibold">Demo login:</span> demo@igrowth.app &nbsp;/&nbsp; demo1234
          </div>
